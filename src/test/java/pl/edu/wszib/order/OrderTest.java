...
public class OrderTest {
    ...
    public void shouldBeAbleToIncreasePositionQuantity() {
        ...
        assertEquals("Incorrect possition quantity", 2, positionQuantity.intValue());
    }
    ...
    public void shouldBeAbleToDecreasePositionQuantity() {
        ...
        Integer positionQuantity = order.getPositionQuantity(1);
        assertEquals("Incorrect possition quantity", 1, positionQuantity.intValue());
    }
    ...
    public void shouldBeAbleToSetPositionQuantity() {
        ...
        Integer positionQuantity = order.getPositionQuantity(1);
        assertEquals("Incorrect possition quantity", newQuantity, positionQuantity);
    }
